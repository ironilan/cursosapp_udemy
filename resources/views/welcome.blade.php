<x-app-layout>
    ...
    <section class="bg-cover" style="background-image: url({{asset('img/home/student-849821_1920.jpg')}});">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-36">
            <div class="w-full md:w-3/4 lg:w-1/2">
                <h1 class="text-white font-bold text-4xl ">Domina la tecnología con Titanocourses</h1>
                <p class="text-white text-lg mt-2 mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam nam officia dolor ipsa cum alias.</p>
    ...
    <section class="mt-24 ">
        <h1 class="text-gray-600 text-center text-3xl mb-6 uppercase">CONTENIDO</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-x-6 gap-y-8   ">
            <article>
                ...
                <p class="text-sm text-gray-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non architecto.</p>
            </article>
            <article>
                <figure>
    ...
    <section class="mt-24 bg-gray-700 py-12">
        <h1 class="text-center text-white text-3xl uppercase">¿No sabes qué curso llevar?</h1>
    ...
    <section class="my-24">
        <h1 class="text-center text-3xl text-gray-600 uppercase">Últimos cursos</h1>
