    									...
    									<div>
    										@if ($lesson->completed)
    											@if ($current->id == $lesson->id)
    												<span class="inline-block h-4 w-4 border-2 border-yellow-300 rounded-full mr-2 mt-1"></span>
    											@else
    												<span class="inline-block h-4 w-4 bg-yellow-300 rounded-full mr-2 mt-1"></span>
    											@endif
    										@else
    											@if ($current->id == $lesson->id)
    												<span class="inline-block h-4 w-4 border-2 border-gray-500 rounded-full mr-2 mt-1"></span>
    											@else
